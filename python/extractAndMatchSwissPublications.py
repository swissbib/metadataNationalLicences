...
def getPath(source, path, journalId=""):
    ...
    if(source=="oxford"):
        ...
        journalFolder=journalId
        if oxford_urlkey.has_key(journalId):
            journalFolder=oxford_urlkey[journalId]
        return base_path+journalFolder.upper()+"/"+pdfname
    if(source=="gruyter"):
        pdfname=os.path.basename(path)
