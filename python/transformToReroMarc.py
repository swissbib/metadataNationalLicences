...
path = '/media/lionel/Data/swissbib/nationalLicencesData/rerodoc/marcxml-swissbib/'
...
myfile = open('/media/lionel/Data/swissbib/nationalLicencesData/rerodoc/rerodocmarc.xml','w')
