...
cd $SOURCE_DIRECTORY
find . -name *.xml -exec  xsltproc -o $TARGET_DIRECTORY{} --stringparam filename {} ~/Documents/mycloud/swissbib/git_repo/metadataNationalLicences/xslt/nlm-2-to-jats-1-1.xsl {} \;
